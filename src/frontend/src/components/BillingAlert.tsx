      ...
      <Alert className="border-yellow-500/50 bg-yellow-500/10">
        ...
        <AlertDescription className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm">
              Your recent payment failed. You have full access for 7 days while
              we retry your payment method. Please update your payment
      ...
      <Alert className="border-destructive bg-destructive/10">
        ...
        <AlertDescription className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-sm">
              Your account has been restricted due to payment failure. File
              uploads are disabled, but you retain read-only access to your data
              and keys. Update your payment method to restore full service
              immediately.
            </p>
          </div>
          {showUpdateButton && (
