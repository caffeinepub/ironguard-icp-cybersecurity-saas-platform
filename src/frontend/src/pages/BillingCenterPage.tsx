...
export default function BillingCenterPage() {
  ...
  const { data: billingStatus, isLoading: billingLoading } =
    useGetCustomerBillingStatus();
  ...
  const handleSubscriptionPayment = async () => {
    ...
    try {
      ...
      toast.error(
        "Failed to initiate payment. Please ensure Stripe is configured.",
      );
  ...
  const currentDetails = subscriptionDetails[profile.subscriptionTier] || {
    storage: "10GB",
    overage: "$0.50/GB",
  };
  ...
  const getBillingStatusBadge = () => {
    ...
    if (billingStatus === BillingStatus.grace) {
      return (
        <Badge
          variant="outline"
          className="text-sm border-yellow-500 text-yellow-500"
        >
      ...
      <div className="flex-1 flex">
        ...
        <main className="flex-1 p-8 overflow-auto">
          <div className="max-w-7xl mx-auto space-y-8">
            {/* Billing Alert */}
            {billingStatus && (
              <BillingAlert status={billingStatus} showUpdateButton={false} />
            )}
                  ...
                  <>
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground">
                          {currentDetails.storage} included storage •{" "}
                          {currentDetails.overage} overage
                        </p>
                      </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p
                            className={`text-sm font-medium ${getBillingStatusColor()}`}
                          >
                      ...
                      >
                        ...
                        {processingPayment
                          ...
                          : billingStatus &&
                            ...
                            ? "Update Payment & Restore Service"
                            : "Confirm Payment"}
                      </Button>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Payments are processed securely through Stripe. We support
                      credit cards, debit cards, Apple Pay, Google Pay, and
                      PayPal.
                    </p>
                  </>
                )}
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-muted-foreground mt-4">
                    Payment methods will be saved securely after your first
                    payment
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <p className="text-sm">
                    Your subscription includes {currentDetails.storage} of
                    storage. If you exceed this amount, you'll be charged{" "}
                    {currentDetails.overage} for each additional GB used.
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                    <li>Storage is calculated monthly based on actual usage</li>
                    <li>No hidden fees or minimum charges</li>
                    <li>
                      Overage charges are billed automatically at the end of
                      each month
                    </li>
                    <li>
                      You can upgrade your plan anytime to get more included
                      storage
                    </li>
                  </ul>
                </div>
