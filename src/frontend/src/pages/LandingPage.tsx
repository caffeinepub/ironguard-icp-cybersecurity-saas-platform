...
import { Activity, Database, FileCheck, Key, Lock, Shield } from "lucide-react";
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                IronGuard ICP is a secure data hosting and cybersecurity
                platform that delivers end-to-end encryption, immutable audit
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 justify-center pt-4">
                <Link to="/auth">
                  <Button
                    size="lg"
                    variant="default"
                    className="w-full sm:w-auto px-8 bg-foreground text-background hover:bg-foreground/90"
                  >
                    Get Started
                  </Button>
                </Link>
          ...
          <div className="container">
            <div className="text-center space-y-4 mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                A unified platform for secure data hosting, identity management,
                and real-time security visibility.
              </p>
            </div>
                ...
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Client-side encryption ensures IronGuard never accesses or
                      processes plaintext data.
                    </CardDescription>
                  </div>
                </CardHeader>
              </Card>
              ...
              <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Cryptographic identity and access control powered by the
                      Internet Computer.
                    </CardDescription>
                  </div>
                </CardHeader>
              ...
              <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Tamper-resistant activity records stored on-chain for full
                      traceability.
                    </CardDescription>
                  </div>
                </CardHeader>
              ...
              <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Encrypted storage for NNS keys with user-only decryption
                      and access control.
                    </CardDescription>
                  </div>
                </CardHeader>
              ...
              <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Live visibility into usage, access events, and security
                      status.
                    </CardDescription>
                  </div>
                </CardHeader>
              ...
              <Card className="border border-border/60 bg-card shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CardDescription className="text-base leading-relaxed">
                      Designed to support SOC 2, GDPR, and HIPAA compliance
                      requirements.
                    </CardDescription>
                  </div>
                </CardHeader>
        ...
        <section className="py-20 md:py-28 bg-muted/20">
          <div className="container">
            <div className="text-center space-y-4 mb-12 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Monitor storage, access activity, and security posture from a
                single dashboard.
              </p>
            </div>
            <div className="max-w-5xl mx-auto">
